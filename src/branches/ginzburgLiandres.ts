...
const BRANCH_PERSON_CONFIG: Record<string, BranchPersonConfig> = {
  ...
  '@I12@': {
    canonicalDisplayName: 'Tzila Cilia Sara Duberstein Alperovitz',
    aliases: [
      'Cilia Sara',
  ...
  '@I60@': {
    canonicalDisplayName: 'Valia Valentina Ginzburg Axelrod',
    aliases: [
      'Vala',
      'Valia',
      'Valentina',
...
export const tzilaImageEvidence: ImageEvidenceItem[] = [
  ...
  },
  {
    ...
    type: 'portrait',
    title: 'Portrait of Tzila Cilia Sara Duberstein Alperovitz with Liri Livnat-Tal',
  ...
  },
  {
    ...
    description: 'Later family photograph showing Tzila Cilia Sara Alperovitz née Dubershtein holding Liri Livnat-Tal.',
    assetPath: '/images/ginzburg/grandmother_cilia_alperovich_nee_dubershtein_liri_livnat-tal.jpg',
    relatedPersonDisplayNames: ['Tzila Cilia Sara Alperovitz née Dubershtein', 'Liri Livnat-Tal'],
    source: 'Family archive',
    confidence: 'direct',
  ...
  },
  {
    ...
    type: 'annotated-photo',
    title: 'Prewar class photo linked to Tzila Cilia Sara Alperovitz née Dubershtein',
    description:
    ...
    relatedPersonIds: ['@I12@'],
    relatedPersonDisplayNames: ['Tzila Cilia Sara Alperovitz née Dubershtein'],
...
const BRANCH_EVIDENCE: BranchEvidenceItem[] = [
  ...
  ...tzilaVideoEvidence,
  {
    ...
    description:
      'Sofia is treated as the earliest known maternal anchor in the current line summary, with branch display preserving the chain Basia -> Sofia -> Tzila Cilia Sara -> Pola -> Yael.',
...
const BRANCH_GENEALOGY_CLAIMS: GenealogyClaim[] = [
  ...
  },
  {
    ...
    type: 'identity',
    subjectId: '@I60@',
    value: 'Valia Valentina Ginzburg Axelrod (born 1928; probably in Tel Aviv)',
    evidenceIds: ['ev-video-tzila-duberstein-01', 'raw-family-structure'],
    confidence: 'partial',
  },
  {
