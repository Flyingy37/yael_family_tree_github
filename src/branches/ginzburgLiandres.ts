...
export const tzilaImageEvidence: ImageEvidenceItem[] = [
  ...
  },
  {
    ...
    titleHe: 'פנקס בוחרים חיפה, 1928',
    description: 'Voter List for Haifa 1928, from the “Voters Knesset Israel 1928” database, document 109, list 5, page 25, IGRA no. 7867. Original records: City Archives - Haifa.',
    descriptionHe: 'פנקס בוחרים חיפה 1928, מתוך מאגר “בוחרים של כנסת ישראל 1928”, מסמך 109, רשימה 5, דף 25, מספר IGRA 7867. מקור הרשומות: ארכיון העיר חיפה.',
    assetPath: '/images/ginzburg/1930_Voters_List_Haifa_040(1).jpg',
    source: 'Voter List for Haifa 1928, from the “Voters Knesset Israel 1928” database, document 109, list 5, page 25, IGRA no. 7867. Original records: City Archives - Haifa.',
    year: 1930,
    confidence: 'partial',
    note:
      'This item is kept as a Mandate-era civic documentation source. The record was added to the search database on 13 October 2012. Relevant family entries should be extracted and verified before being linked directly to the family graph.',
    noteHe: 'רשומה זו נשמרת כפריט תיעוד אזרחי מתקופת המנדט. היא נוספה למאגר החיפוש ב־13 October 2012. יש לחלץ בנפרד את הרשומות המשפחתיות הרלוונטיות ולאמת אותן לפני קישור ישיר לגרף המשפחה.',
  },
  {
  ...
  {
    id: 'ev-image-tzila-dubershtein-class-photo-pre-1941',
    type: 'annotated-photo',
    title: 'Class photograph linked to Tzila Alperovitz née Dubershtein',
    description:
      'School class photograph from the period before the Nazi invasion, identified in family annotation as showing Tzila Alperovitz née Dubershtein at the lower right, with braids.',
    assetPath: '/images/ginzburg/Ciila Alperovich, class photo, graduation from eighth grade, the period before the Nazi invasion.1941.jpg',
    relatedPersonIds: ['@I12@'],
    relatedPersonDisplayNames: ['Tzila Alperovitz née Dubershtein'],
    yearApprox: 'before June 1941',
    source: 'Family archive with later family annotation',
    confidence: 'partial',
    note: 'Family-supplied identification; family notes also state that about half of her classmates perished during the war in Belarus.',
  },
];
