...
function translateEvidenceItem(item: BranchEvidenceItem, isHebrew: boolean, branchUrlBase?: string): BranchEvidenceItem {
  ...
  const copy: Record<string, Partial<BranchEvidenceItem>> = {
    ...
    'ev-document-haifa-voters-list-1930': {
      title: 'עמוד מרשימת הבוחרים של חיפה, 1930',
      description: 'סריקה של עמוד מתוך רשימת הבוחרים של חיפה משנת 1930, כפריט תיעוד בהקשר נוכחות המשפחה בארץ בתקופת המנדט.',
      note:
        'הפריט נשמר כתיעוד מסייע למחקר, עד לחילוץ מלא של הרשומות המשפחתיות הרלוונטיות ולאימותן.',
