...
const COPY = {
  he: {
    ...
    lead:
      'אתר מחקר משפחתי שמאגד אנשים, מקומות וקשרים בין ענפי המשפחה. כאן אפשר לגלות, לא ללכת לאיבוד.',
    ctaExplore: 'כניסה לחקר',
    cards: [
      {
        to: '/explore/tree',
        icon: '🌳',
        title: 'חפשו אדם או ענף',
        text: 'עץ אינטראקטיבי, תתי־עצים וחיפוש חכם בשמות ובמקומות.',
      },
      {
        to: '/explore/timeline',
        icon: '📅',
      ...
      },
      {
        ...
        icon: '📊',
        title: 'תמונת עומק',
        text: 'סטטיסטיקות וסינונים מתקדמים למי שרוצה לחקור לעומק.',
      },
    ],
    ...
    cards: [
      {
        to: '/explore/tree',
        icon: '🌳',
        title: 'Find a person or branch',
        text: 'Interactive tree, subtrees, and smart search across names and places.',
      },
      {
        to: '/explore/timeline',
        icon: '📅',
        title: 'Family timeline',
        text: 'Births, deaths, and events in chronological order.',
      },
      {
        to: '/explore/map',
        icon: '🗺️',
      ...
      },
      {
        to: '/explore/stats',
        icon: '📊',
        title: 'Deeper picture',
        text: 'Statistics and filters for researchers who want more detail.',
      },
    ],
    ...
    <div className="min-h-screen bg-gradient-to-b from-stone-50 via-amber-50/30 to-stone-100" dir={dir}>
      ...
      <main className="max-w-5xl mx-auto px-4 py-12 md:py-16">
        <section className="text-center mb-14 md:mb-20">
          <p className="text-5xl md:text-6xl mb-4" aria-hidden>
            🌳
          </p>
