...
export function TreeView({ persons, families, filteredIds, rootPersonId, selectedPersonId, onSelectPerson, language = 'en' }: Props) {
  ...
  const initialNodes: Node[] = useMemo(() =>
    ...
    [layoutNodes, rootPersonId, selectedPersonId, handleNodeClick, language]
  );
